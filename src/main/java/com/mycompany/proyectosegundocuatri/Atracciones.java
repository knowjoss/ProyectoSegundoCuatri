...
public class Atracciones {
    ...
    private void agregarNuevaAtraccion(String nombre, String descripcion) {
        if (contador < lista.length) {
            ...
            contador++;//aumentara siempre que haya espacio
        }
    }
    ...
    public void agregarAtraccion() {
        ...
        lista[contador] = new Atraccion(nombre, descripcion);
        contador++;// al verificar que haya espacio, lo añadira 
    ...
    public void editarAtraccion() {
        ...
        for (int i = 0; i < contador; i++) {// la varriable i se iguala a 0 para indicar el valor en el arreglo, 
